...
/// Room detail bottom sheet (Figma "One Room Page") — photo carousel,
/// highlights grid, full amenity list, free-cancellation note, and
/// Select/Back actions.
class RoomDetailsSheet extends StatelessWidget {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _actionButtons(room, controller),
  ...
  /// Two-column, row-paired layout — the room-details grids only ever hold an
  /// even, small (≤6) item count, so a manual pairing loop is simpler than
  /// pulling in a grid widget for it.
...
Widget _actionButtons(RoomOption room, BookingFlowController controller) =>
    Column(
